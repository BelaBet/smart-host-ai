...
import OnboardingSecure from "./pages/OnboardingSecure";
...
<Route path="/" element={<Index/>}/><Route path="/login" element={<Login/>}/><Route path="/checkout" element={<Checkout/>}/><Route path="/onboarding" element={<ProtectedRoute><OnboardingSecure/></ProtectedRoute>}/><Route path="/reset-password" element={<ResetPassword/>}/>
